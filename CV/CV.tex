...
\section{Academic Service}
  \resumeSubHeadingListStart
    \honor {Conference Reviewer: ICLR, CVPR, ECCV, ICML, KDD, MICCAI}{2025 - Present}
    \honorLast {Journal Reviewer: TPAMI, IEEE TNNLS, TMLR, IEEE Trans. on Reliability, Pattern Recognition, et. al.}{2025 - Present}
  \resumeSubHeadingListEnd
